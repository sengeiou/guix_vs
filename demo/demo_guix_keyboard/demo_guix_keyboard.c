...
static int guix_main(UINT(*drv_setup)(GX_DISPLAY*))
{
    ...
    gx_studio_display_configure(DISPLAY_1, drv_setup,
...
int main(int argc, char* argv[])
{
    ...
    screen.pixel_format = DISPLAY_1_COLOR_FORMAT;
    screen.pixel_width = 2;
    screen.screen_height = DISPLAY_1_Y_RESOLUTION;
    screen.screen_width = DISPLAY_1_X_RESOLUTION;
...
VOID key_widget_draw(KEY_WIDGET *key)
{
    INT x_offset = 0;
    INT y_offset = 1;
    GX_RESOURCE_ID font_id = GX_FONT_ID_DEFAULT;
    GX_PIXELMAP *map;
    GX_STRING string;
